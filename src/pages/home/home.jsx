...
export default function Home() {
    ...
    return (
        <div>
            <img src={computerMike} class="split left" />

            <div class="split right">
                <div class="centered">
                    <div className='homeTitle'>BLOGCAST...</div>
                    <div className='homesubTitle'>Far and Near!</div>
                    <div className='homedes'>Think you have lost yourself somewhere... We will find you here!</div>
                    <button class="cta" onClick={redirectToEpisodes}>
                        <span class="hover-underline-animation"> Listen Now... </span>
                        <svg viewBox="0 0 46 16" height="10" width="30" xmlns="http://www.w3.org/2000/svg" id="arrow-horizontal">
                            <path transform="translate(30)" d="M8,0,6.545,1.455l5.506,5.506H-30V9.039H12.052L6.545,14.545,8,16l8-8Z" data-name="Path 10" id="Path_10"></path>
                        </svg>
                    </button>
                    <div className='homedesFooter'>Subscribe and listen on major platform</div>
                    <div className="cardspotify">
                        ...
                        <a href={amazonlink} class="socialContainer containerFour"  target="_blank">
